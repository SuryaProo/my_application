...
function Navbar() {
  return (
    <>
      <div class="relative w-full bg-blue-300 p-2">
        <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
          <div class="inline-flex items-center space-x-2">
            ...
            <span class="font-bold">Zeblearn india</span>
          </div>
          ...
          <div>
            <div className="flex bg-blue-300 w-1/1 ">
              <ul className="flex row-auto m-2 gap-5  text-center">
