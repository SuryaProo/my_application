...
function Footer() {
  return (
    <>
      <footer class="w-full bg-violet-400 mt-2">
        <div class="mx-auto flex max-w-6xl flex-col items-start space-x-8 md:flex-row">
          <div class="w-full px-4 md:w-1/2 lg:px-0">
            <h1 class="max-w-sm text-3xl font-bold">
              Zeblearn simplified Education
            </h1>
            <p className=" text-white">
              Our courses cover a range of SAP modules, including HCM,
              accounting, FICO, SuccessFactors, S4 HANA, project system,
              maintenance, SD, MM, PP, and more
            </p>
            {/* <form
              action=""
          ...
          <div class="mt-8 grid grid-cols-2 gap-6 md:mt-0 lg:w-3/4 lg:grid-cols-3">
            <div class="mb-8 lg:mb-0">
              <p class="mb-6 text-lg font-semibold text-gray-700 ">support</p>
